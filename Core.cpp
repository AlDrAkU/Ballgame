...
void Core::Initialize( )
{
	...
	{
		std::cout << "Core::Initialize( ), error when calling SDL_Init: " << SDL_GetError( ) << std::endl;
		return;
	}
	...
	{
		std::cout << "Core::Initialize( ), error when calling SDL_CreateWindow: " << SDL_GetError( ) << std::endl;
		return;
	}
	...
	{
		std::cout << "Core::Initialize( ), error when calling SDL_GL_CreateContext: " << SDL_GetError( ) << std::endl;
		return;
	}
	...
	if ( m_Window.isVSyncOn )
	{
		...
		{
			std::cout << "Core::Initialize( ), error when calling SDL_GL_SetSwapInterval: " << SDL_GetError( ) << std::endl;
			return;
		}
	}
	...
	{
		std::cout << "Core::Initialize( ), error when calling IMG_Init: " << IMG_GetError( ) << std::endl;
		return;
	}
	...
	if ( TTF_Init( ) == -1 )
	{
		std::cout << "Core::Initialize( ), error when calling TTF_Init: " << TTF_GetError( ) << std::endl;
		return;
	}
...
void Core::Run( )
{
	if ( !m_Initialized )
	{
		std::cout << "Core::Run( ), Core not correctly initialized, unable to run the game\n";
		std::cin.get( );
		return;
	}
